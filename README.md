<p align="center">
	<h1 align="center"><b>DaiC Plugins</b></h1>
	<p align="center">
		Official plugins from the DaiC team
    <br />
    <br />
    <a href="https://github.com/DaiC-re/DaiC-Plugins/releases"><b>Downloads </b></a>
    <br />
  </p>
</p>
<br/>

This is our repository for all plugins made by the DaiC team, all are fully supported for the latest version of DaiC.

# Type of plugins:

We use our Python and C++ API for the creation of those plugins, you can have an overview of those API with our
[documentation](https://daic.re/docs/).
...
- All plugins above are available under the MIT license as defined in [LICENSE](https://github.com/DaiC-re/DaiC-Plugins/blob/master/LICENSE)
